...
# returns last number in response
...
def main():
    ...
    for i in range(len(model_paths)):
        ...
        with torch.no_grad():
            for prompt_texts, enc_batch, answers in val_dataloader:
                ...
                print('average response length so far',)
    ...
    print(df)
    df.to_json("/om/user/tiffany8/grpo-urop/TinyZero/response_analysis/aime/responses_aime.jsonl", orient="records", lines=True)
