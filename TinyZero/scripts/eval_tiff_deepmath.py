...
### ~~PICK MODEL PATH~~
# deepmath (missing ppo + dpo)
model_paths = ["/om/user/tiffany8/grpo-urop/TinyZero/model/deepseek-math-7b-instruct",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/deepmath7b-instruct-grpo/actor/global_step_300",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/deepmath7b-instruct-reinforce/actor/global_step_400"]
