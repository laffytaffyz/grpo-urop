...
### ~~PICK MODEL PATH~~
# gpt2
model_paths = ["/om/user/tiffany8/grpo-urop/TinyZero/model/gpt2-sft/global_step_116",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/gpt2-ppo/actor/global_step_1700",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/gpt2-grpo/actor/global_step_800",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/gpt2-reinforce/actor/global_step_200",
                "/om/user/tiffany8/grpo-urop/TinyZero/checkpoints/TinyZero/gpt2-dpo/actor/global_step_200"]
